...
setupTab = ->
  ...
  for w, i in works
    ...
    tabHtml += "<div class=\"#{t}\">"
    tabHtml += "<div class=\"mdl-card__title\"><h2 class=\"h4 mdl-card__title-text\">#{w.name}</h2></div>"
    tabHtml += "<div class=\"mdl-card__supporting-text\"><p>#{w.desc}</p></div>"
    tabHtml += "<div class=\"mdl-card__actions mdl-card--border\" id=\"buttons\">"
